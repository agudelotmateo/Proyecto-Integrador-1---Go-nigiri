 ...
 */
class LevelHiraganaAdapter extends RecyclerView.Adapter<LevelHiraganaAdapter.CourseViewHolder> implements ItemClickListener {
    private final Context context;
    private List<HiraganaLevel> items;


    public LevelHiraganaAdapter(Context context, List<HiraganaLevel> items) {
