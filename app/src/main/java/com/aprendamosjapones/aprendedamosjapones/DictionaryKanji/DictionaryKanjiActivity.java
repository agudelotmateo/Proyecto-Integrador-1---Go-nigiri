...
public class DictionaryKanjiActivity extends Activity {
    ...
    public void prepareList()
    {
        ...
        listNamesKanji.add("Lluvia");
          ...
          listImageKanji.add(R.drawable.kanji5a_o);
          ...
          listImageKanji.add(R.drawable.kanji10adentro);
          ...
          listImageKanji.add(R.drawable.kanji14hora);
          listImageKanji.add(R.drawable.kanji15viajar);
          ...
          listImageKanji.add(R.drawable.kanji22intervalo);
          listImageKanji.add(R.drawable.kanji23arriba);
          listImageKanji.add(R.drawable.kanji24este);
        ...
        listImageKanji.add(R.drawable.kanji33ni_o);
        ...
        listImageKanji.add(R.drawable.kanji37abajo);
        ...
        listImageKanji.add(R.drawable.kanji43hablar);
        ...
        listImageKanji.add(R.drawable.kanji56oeste);
        ...
        listImageKanji.add(R.drawable.kanji60tierra);
