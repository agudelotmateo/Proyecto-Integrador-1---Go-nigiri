 ...
 */
class LevelKatakanaAdapter extends RecyclerView.Adapter<LevelKatakanaAdapter.CourseViewHolder> implements ItemClickListener {
    private final Context context;
    private List<KatakanaLevel> items;


    public LevelKatakanaAdapter(Context context, List<KatakanaLevel> items) {
    ...
    public void onBindViewHolder(CourseViewHolder viewHolder, int i) {
        ...
        KatakanaLevel currentItem = items.get(i);
