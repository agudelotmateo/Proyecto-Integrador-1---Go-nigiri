...
public class DictionaryAdapter extends RecyclerView.Adapter<DictionaryAdapter.CourseViewHolder>
    ...
    private List<ItemsDictionaryKatakana> items;


    public DictionaryAdapter(Context context, List<ItemsDictionaryKatakana> items) {
    ...
    public void onBindViewHolder(CourseViewHolder viewHolder, int i) {
        ...
        ItemsDictionaryKatakana currentItem = items.get(i);
    ...
    public void onItemClick(View view, int position) {
        ...
        DetailsDictionaryKatakana.launch(
